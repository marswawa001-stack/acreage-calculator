      ...
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">
            Backlink: <a className="text-blue-600 hover:underline" href="https://www.calculatorvast.com/acreage-calculator" target="_blank" rel="noreferrer">https://www.calculatorvast.com/acreage-calculator</a>
          </p>
        </header>
